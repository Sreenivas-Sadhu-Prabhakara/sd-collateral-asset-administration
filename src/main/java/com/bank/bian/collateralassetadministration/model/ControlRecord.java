package com.bank.bian.collateralassetadministration.model;
...
/**
 * The BIAN control record for this service domain: "Collateral Valuation Administrative Plan".
 *
 ...
 * to its asset type (Collateral Valuation). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Collateral Valuation Administrative Plan";
